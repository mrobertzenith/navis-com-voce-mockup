...
export const IMOVEIS_SEED: Imovel[] = [
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08841', valorEstimado: 640000,
  ...
  construir({
    ...
    tipo: 'casa_condominio', cib: 'CIB-RP-08842', valorEstimado: 1650000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08843', valorEstimado: 1150000,
  ...
  construir({
    ...
    tipo: 'sala_comercial', cib: 'CIB-FR-01920', valorEstimado: 260000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08844', valorAnuncio: 720000,
  ...
  construir({
    ...
    tipo: 'terreno_condominio', cib: 'CIB-CP-02210', valorAnuncio: 480000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08845', valorAnuncio: 495000,
  ...
  construir({
    ...
    tipo: 'casa_rua', cib: 'CIB-SC-00791', valorAnuncio: 520000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08801', valorAnuncio: 480000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08802', valorAnuncio: 690000,
  ...
  construir({
    ...
    tipo: 'casa_condominio', cib: 'CIB-RP-08803', valorAnuncio: 1890000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08804', valorAnuncio: 1290000,
  ...
  construir({
    ...
    tipo: 'sala_comercial', cib: 'CIB-RP-08805', valorAnuncio: 340000,
  ...
  construir({
    ...
    tipo: 'casa_rua', cib: 'CIB-RP-08806', valorAnuncio: 590000,
  ...
  construir({
    ...
    tipo: 'terreno_condominio', cib: 'CIB-RP-08807', valorAnuncio: 620000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-CP-02240', valorAnuncio: 950000,
  ...
  construir({
    ...
    tipo: 'galpao_comercial_industrial', cib: 'CIB-FR-01950', valorAnuncio: 2100000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-SP-04410', valorAnuncio: 1350000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08750', valorAnuncio: 560000,
  ...
  construir({
    ...
    tipo: 'casa_rua', cib: 'CIB-CP-02087', valorAnuncio: 480000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08355', valorAnuncio: 640000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-RP-08201', valorAnuncio: 410000, valorVenda: 398000,
  ...
  construir({
    ...
    tipo: 'casa_rua', cib: 'CIB-RP-08099', valorAnuncio: 520000, valorVenda: 505000,
  ...
  construir({
    ...
    tipo: 'apartamento', cib: 'CIB-CP-02068', valorAnuncio: 720000, valorVenda: 690000,
